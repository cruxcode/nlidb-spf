...
class Seed{
    ...
    public void Adjectives(String adj, int level, String pred, String greater, String max){
        String entry = "";
        if(level == 0){
    ...
    public void Adjectives(String adj, int level, String greater, String max){
        String entry = "";
        if(level == 1){
