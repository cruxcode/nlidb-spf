...
//				seed_file.ColGenerator(s1,s.TrackType.get(s2),s.TrackType.get(s3),"type2");
//				seed_file.ColGenerator(s1,s.TrackType.get(s2),s.TrackType.get(s3),"type3");
...
//					s2 = s.RelationList.get(i).Primarydetails.Type;
//					s3 = s.RelationList.get(i).ColumnList.get(j).Type;
...
//	public static void hGenerator(Nodes x, ArrayList<String> hierar_list, Schema s) {
//		for(int i=0;i<x.children.size();i++) {
//			hierar_list.add("("+s.TrackType(x.children.get(i).name)+","+s.TrackType(x.name)+")"+"       // "+x.children.get(i).name);
//		}
//		for(int i=0;i<x.children.size();i++) {
//			hGenerator(x.children.get(i),hierar_list, s);
//		}
//	}
